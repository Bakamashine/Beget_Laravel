...
<body class="h-full bg-admin_wallpaper">
        ...
        <div class="ml-auto mr-2 flex">
            ...
            <div id="parent_account" class="h-full">
                ...
                <div class="h-full group hover:bg-admin_black_hover w-72  transition-all duration-[400ms] ease-in-out">
                    <button id="account" class="h-full w-full flex justify-center items-center group-hover:text-admin_svg_hover text-white">
                        {{Auth::user()->name}}
                    </button>
                </div>
    ...
    <section id="admin-menu" class="bg-admin_black w-[272px] pb-[100%] ">
        
        <div class="pt-2">

            <a href="{{route("admin")}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
        ...
        <div id="menu_spoiler">
            ...
            <a href="#" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
