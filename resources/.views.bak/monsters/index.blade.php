	...
	<form method="post" class="space-y-4" action="{{route("monsters.store")}}">
		@csrf
            ...
            <div>
                ...
                <input type="text" id="price" name="price" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >
                @error('price')
                    {{$message}}
                @enderror
            </div>
