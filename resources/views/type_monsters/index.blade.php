	...
	<form method="post" class="space-y-4" action="{{route("type_monsters.store")}}">
		@csrf
            ...
            <div>
                ...
                <input type="text" id="name" name="type" class="mt-1 block mobile:w-full max-mobile:w-4/5 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
            </div>

            <div>
                <label for="speed" class="block text-sm font-medium text-gray-700">Скорость</label>
                <input type="text" id="speed" name="speed" class="mt-1 block mobile:w-full max-mobile:w-4/5 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                @error('speed')
                    {{$message}}
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" id="element" name="element" class="mt-1 block mobile:w-full max-mobile:w-4/5 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >
            </div>


            <div>
                <label for="description" class="block text-sm font-medium text-gray-700">Описание</label>
                <input type="text" id="description" name="description" class="mt-1 block mobile:w-full max-mobile:w-4/5 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >
            </div>

            <div>
                <label for="resist" class="block text-sm font-medium text-gray-700">Сопротивляемость</label>
                <input type="text" id="resist" name="resist" class="mt-1 block mobile:w-full max-mobile:w-4/5 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >
            </div>
...
<div>
            ...
            <div>
                ...
                <input type="text" id="recommendations" name="recommendations" class="mt-1 block mobile:w-full max-mobile:w-4/5  border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" >
            </div>
