...
<body class="h-full bg-admin_wallpaper">
    ...
    >
        ...
        <div class="pt-2">
            ...
            <a href="{{route("main")}}" class="group block max-mobile:border-t-2 max-mobile:border-b-2 max-mobile:border-red-500 hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Главная</p>
            </a>

            @guest
            <a href="{{route("register")}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Регистрация</p>
            </a>

            <a href="{{route("login")}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Авторизация</p>
            </a>
            @endguest

            @auth
            <a href="{{route('cart')}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Желаемое</p>
            </a>
            
            
            <a href="{{route('comments')}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Написать отзыв</p>
            </a>
            @endauth

            <a href="{{route("products")}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Монстры</p>
            </a>

            <a href="{{route('eat')}}" class="group block hover:bg-admin_menu_btn h-10 text-admin_text_color flex">
                <div class="group-hover:bg-white transition-all duration-75 ease-linear h-full w-1"></div>
                <p class="p-2">Чем их кормить?</p>
            </a>
        ...
        {{-- Есть вариант ещё сделать w-[300px] --}}
