    ...
    <div class="flex flex-wrap justify-center  pt-28">
        @foreach($imgs as $img)
            <div class="mr-10 mt-4">
                ...
                <button class="mx-auto mt-5 block hover:text-blue-500 m-10  h-[36px] rounded-xl transition-all duration-200 ease-in"  name="radio_img" id="radio" value="{{$img->path}}">Добавить</button>
            </div>
        @endforeach
    </div>
        <div>
